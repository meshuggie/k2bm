    ...
    function updateBMMenu() {
      ...
      k2Sites.forEach(function(site) {
          if ( $('.sod_option[title*="' + site + '"]').length > 1 ) {
              ...
              tamperMenuHtml += '<span class="sod_option" title="' + site + '" style="padding: 10px; margin: 5px 0;">' + site + '<span style="position: absolute;transform: translate(0, -50%);top: 46%;right: 7px;font-weight: bold;font-size: 24px;">&rsaquo;</span></span>';
